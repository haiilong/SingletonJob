...
| [troubleshooting.md](troubleshooting.md) | Common pitfalls, log lines decoded, perf tips |

The top-level [README.md](../README.md) has the elevator pitch and a 30-line quickstart.
